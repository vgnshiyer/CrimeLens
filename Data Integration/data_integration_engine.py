...
class DataLoader:
    ...
    def add_crime_event(self, row):
        ...
        g.add((crime_event_uri, ns['hasVictimID'], Literal(row['INCIDENT_KEY'], datatype=XSD.integer)))
        g.add((crime_event_uri, ns['hasPerpetratorID'], Literal(row['INCIDENT_KEY'], datatype=XSD.integer)))
        g.add((crime_event_uri, ns['hasLocationID'], Literal(row['INCIDENT_KEY'], datatype=XSD.integer)))
    ...
    def add_location(self, row):
        ...
        g.add((location_uri, ns['hasLocationID'], Literal(row['INCIDENT_KEY'], datatype=XSD.integer)))
